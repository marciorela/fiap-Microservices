...
namespace GeekBurger.Queue
{
    ...
    {
        const string QueueConnectionString = "Endpoint=sb://geekburger-rela.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=KxO1DEqEkzigsIi+iJ6heMKd7RvasoiWA81ZcSpa1Mw=";
